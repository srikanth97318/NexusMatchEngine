from src.member3_ranking.feature_engineering import calculate_trajectory_velocity, build_ltr_features
...
def test_lightgbm_ranker_inference():
    ...
    candidate_features = [
        {"skill_match_score": 0.8, "semantic_similarity": 0.7, "trajectory_velocity": 0.5, "exp_ratio": 1.0},
        {"skill_match_score": 0.4, "semantic_similarity": 0.5, "trajectory_velocity": 0.2, "exp_ratio": 0.5}
    ]
